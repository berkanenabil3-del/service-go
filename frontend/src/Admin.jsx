      ...
      <div className="container flex items-center justify-center relative" style={{ minHeight: '100vh' }}>
        ...
        <form onSubmit={handleLogin} className="glass card w-full" style={{ maxWidth: '400px' }}>
          ...
          <div className="text-center mt-4">
            <a href="/" className="text-sm text-muted hover:text-primary transition-colors">← Retour au site client</a>
          </div>
        </form>
      </div>
    );
    ...
    <div className="container" style={{ maxWidth: '1000px', paddingTop: '40px', paddingBottom: '40px' }}>
      <header className="flex justify-between items-center mb-8 flex-wrap gap-4">
        ...
        <div className="flex gap-3 items-center flex-wrap">
          <a href="/" className="btn" style={{ padding: '8px 14px', backgroundColor: '#f1f5f9', color: '#475569', width: 'auto', border: '1px solid #cbd5e1' }}>
            ← Voir le site
          </a>
          <ThemeToggle />
